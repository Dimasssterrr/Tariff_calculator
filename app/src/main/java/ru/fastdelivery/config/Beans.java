...
public class Beans {
    ...
    @Bean
    public TariffCalculateUseCase tariffCalculateUseCase(WeightPriceProvider weightPriceProvider, DepartureDestinationPropertiesProvider propertiesProvider) {
        return new TariffCalculateUseCase(weightPriceProvider,propertiesProvider);
    }
